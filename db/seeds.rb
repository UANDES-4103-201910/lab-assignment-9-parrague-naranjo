...
event_1 = Event.create(name: 'ICPC 2018', start_date: DateTime.new(2019, 07, 15), place: place_1)
event_2 = Event.create(name: 'Facebook Hackathon 2018', start_date: DateTime.new(2019, 07, 20), place: place_1)
event_3 = Event.create(name: 'Lollapalooza 2018', start_date: DateTime.new(2019, 07, 25), place: place_2)
event_4 = Event.create(name: 'Festival de Viña 2018', start_date: DateTime.new(2019, 07, 30), place: place_2)
